...
function PricingComponent() {
  ...
  return (
    <section className="section">
      <div className="flex flex-col md:flex-row justify-center p-6 w-full ">
        <div className="flex flex-col bg-white  rounded p-4 m-2 lg:w-1/3 bg-gray-100">
        ...
        <div className="flex flex-col bg-white border-4 border-blue-500 rounded p-4 m-2 lg:w-1/3">
